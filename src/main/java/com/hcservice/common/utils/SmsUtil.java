...
public class SmsUtil {
    ...
    @Value("${tencentSms.appurl}")
    private String appUrl = "sms.tencentcloudapi.com";

    @Value("${tencentSms.SDKAppID}")
    private String SDKAppID = "1400510982";

    @Value("${tencentSms.SDKAppKey}")
    private String SDKAppKey = "8e67a3a4dd8cc28beefd65d102fdfe06";
     ...
     * @return
     */
    public SendSmsResponse sendSms(String templateId, String nationCode, String phoneNumbers) {
     ...
     * @return
     */
    public SmsSingleSenderResult sendCode(String phone, String nationCode, String code, Integer templateId) {
        String[] phoneNumbers = {phone}; //手机号可以添很多。
        String smsSign = "西山龙胤"; //短信签名
        nationCode = nationCode.substring(1);
        SmsSingleSenderResult result = new SmsSingleSenderResult();
        try {
            String[] params = {code, "5"};  //第一个参数传递{1}位置想要的内容，第二个传递{2}的内容，以此类推。
            SmsSingleSender sender = new SmsSingleSender(Integer.parseInt(SDKAppID), SDKAppKey);
